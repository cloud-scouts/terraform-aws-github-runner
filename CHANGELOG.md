...
## [7.0.0](https://github.com/cloud-scouts/terraform-aws-github-runner/compare/v6.6.0...v7.0.0) (2025-07-03)


### ⚠ BREAKING CHANGES

* Enable eventbridge by default ([#4320](https://github.com/cloud-scouts/terraform-aws-github-runner/issues/4320))
* remove deprecated metric feature flag ([#4319](https://github.com/cloud-scouts/terraform-aws-github-runner/issues/4319))
* Upgrade Node to 22 (LTS) ([#4318](https://github.com/cloud-scouts/terraform-aws-github-runner/issues/4318))
* remove deprecated variables ([#4073](https://github.com/cloud-scouts/terraform-aws-github-runner/issues/4073))
* Remove FIFO queues ([#4072](https://github.com/cloud-scouts/terraform-aws-github-runner/issues/4072))
* remove deprecated runners_scale_up_Lambda_memory_size as it breaks CDKTF ([#4276](https://github.com/cloud-scouts/terraform-aws-github-runner/issues/4276))
...
* add time zone support for pool schedules ([#4063](https://github.com/cloud-scouts/terraform-aws-github-runner/issues/4063)) ([b8f9eb4](https://github.com/cloud-scouts/terraform-aws-github-runner/commit/b8f9eb4638efbb45a7e27ddb66b3a10eef2617a7))
* Enable eventbridge by default ([#4320](https://github.com/cloud-scouts/terraform-aws-github-runner/issues/4320)) ([142bb61](https://github.com/cloud-scouts/terraform-aws-github-runner/commit/142bb61539c00e5fc661725c4fc924c4128484cc))
...
* migrate launch template to use SSM for AMI lookup ([#4517](https://github.com/cloud-scouts/terraform-aws-github-runner/issues/4517)) ([472cc5f](https://github.com/cloud-scouts/terraform-aws-github-runner/commit/472cc5f6175d79e26260e0ed7a9cac7fc299411f))
...
* Natively support runner pre/post job hooks ([#4263](https://github.com/cloud-scouts/terraform-aws-github-runner/issues/4263)) ([259a852](https://github.com/cloud-scouts/terraform-aws-github-runner/commit/259a852d9e1b08f18abe81c9fd80589be9cc7e64))
* opt-out ssm parameters for github app ([#4335](https://github.com/cloud-scouts/terraform-aws-github-runner/issues/4335)) ([a2f013f](https://github.com/cloud-scouts/terraform-aws-github-runner/commit/a2f013f4352912b618ffc071ef8ea06376ed9c5b))
* **packer:** Allow passing in an instance_profile to packer ([#4278](https://github.com/cloud-scouts/terraform-aws-github-runner/issues/4278)) ([bb7346b](https://github.com/cloud-scouts/terraform-aws-github-runner/commit/bb7346bee8340af03a61e85a3cb129da68543612))
...
* **runners:** add support to disable default labels (Linux) ([#3491](https://github.com/cloud-scouts/terraform-aws-github-runner/issues/3491)) ([772e1a5](https://github.com/cloud-scouts/terraform-aws-github-runner/commit/772e1a59906f171c6dc70183544443509f9c0580))
* **runners:** add support to disable default labels (Windows) ([#4261](https://github.com/cloud-scouts/terraform-aws-github-runner/issues/4261)) ([ad9bcc4](https://github.com/cloud-scouts/terraform-aws-github-runner/commit/ad9bcc47f8105098811175379b9eed68d73f7d92))
* **runner:** support Ubuntu 24.04 ([#4246](https://github.com/cloud-scouts/terraform-aws-github-runner/issues/4246)) ([76456b5](https://github.com/cloud-scouts/terraform-aws-github-runner/commit/76456b5f625fa36140b7a7e9c1a104b248eeef7f))
...
* Upgrade Node to 22 (LTS) ([#4318](https://github.com/cloud-scouts/terraform-aws-github-runner/issues/4318)) ([c5d4693](https://github.com/cloud-scouts/terraform-aws-github-runner/commit/c5d4693c7e8889ee9f1672385e26278275d771c2))
* **webhook:** Enable authorizer assignment to webhook ([#4000](https://github.com/cloud-scouts/terraform-aws-github-runner/issues/4000)) ([b78ccde](https://github.com/cloud-scouts/terraform-aws-github-runner/commit/b78ccde771f6c24b736e046cd41acb72308baac0))


### Bug Fixes

* [#4218](https://github.com/cloud-scouts/terraform-aws-github-runner/issues/4218) ([380bcaf](https://github.com/cloud-scouts/terraform-aws-github-runner/commit/380bcaf68447fb05be6c888392b46449cf5d409d))
* add comment in terraform code ([d9d6373](https://github.com/cloud-scouts/terraform-aws-github-runner/commit/d9d6373b217f8abe7b112c1746c437deae25f569))
* add default filter with empty prefix due to changes in AWS Provider 5.90.0 ([1ba9dcc](https://github.com/cloud-scouts/terraform-aws-github-runner/commit/1ba9dcc6a8110bbadc00851f3522a96f4c0c8953))
* add missing prefix to ami cleanur for event rule ([#4098](https://github.com/cloud-scouts/terraform-aws-github-runner/issues/4098)) ([1ad118b](https://github.com/cloud-scouts/terraform-aws-github-runner/commit/1ad118bd516cc29919a2ec9deb9c9362f635f953))
* Add missing SG and subnet configuration for Job Retry lambda ([#4114](https://github.com/cloud-scouts/terraform-aws-github-runner/issues/4114)) ([7095487](https://github.com/cloud-scouts/terraform-aws-github-runner/commit/7095487325d4f63acd246e508e2e997cf13a2249))
...
* added missing launch template tag_specifications ([#4544](https://github.com/cloud-scouts/terraform-aws-github-runner/issues/4544)) ([f2eb809](https://github.com/cloud-scouts/terraform-aws-github-runner/commit/f2eb80943166680daa204234a2b3bcfab92f07c5))
* align inlince policies ([#4046](https://github.com/cloud-scouts/terraform-aws-github-runner/issues/4046)) ([7235cdc](https://github.com/cloud-scouts/terraform-aws-github-runner/commit/7235cdc40686f3218e1991ec9a8feeb900b719f1)), closes [#4045](https://github.com/cloud-scouts/terraform-aws-github-runner/issues/4045)
...
* broken docs after removing examples ([#4321](https://github.com/cloud-scouts/terraform-aws-github-runner/issues/4321)) ([7171215](https://github.com/cloud-scouts/terraform-aws-github-runner/commit/71712159cd4ad8ae6cb6371e0342b1c6bf663c54))
...
* **ci:** add attestation for lambda artifacts to release ([#4351](https://github.com/cloud-scouts/terraform-aws-github-runner/issues/4351)) ([7387ac8](https://github.com/cloud-scouts/terraform-aws-github-runner/commit/7387ac867c9d581c0306440ffd78c80be0f61d25))
...
* dependency updates lambda ([#3965](https://github.com/cloud-scouts/terraform-aws-github-runner/issues/3965)) ([a6df2b6](https://github.com/cloud-scouts/terraform-aws-github-runner/commit/a6df2b65dd74a911e9403f7ae7a03230d5003e8e))
* Disable interpolation of HEREDOC strings containing runner hook scripts ([#4333](https://github.com/cloud-scouts/terraform-aws-github-runner/issues/4333)) ([2622589](https://github.com/cloud-scouts/terraform-aws-github-runner/commit/26225898b6a55d38f96938c95ba55c7b0319343d))
* dispatch only queued events to runners ([#4257](https://github.com/cloud-scouts/terraform-aws-github-runner/issues/4257)) ([a0a8322](https://github.com/cloud-scouts/terraform-aws-github-runner/commit/a0a8322b539edab279a8570507f6f83ec11a290a))
* Dispatcher kms permission role mismatch ([#4547](https://github.com/cloud-scouts/terraform-aws-github-runner/issues/4547)) ([cae3e74](https://github.com/cloud-scouts/terraform-aws-github-runner/commit/cae3e74ddabc8e65731eca5209144de1df7d3415))
* **docs:** github artifact attestation command in release notes ([#4624](https://github.com/cloud-scouts/terraform-aws-github-runner/issues/4624)) ([ff39d4f](https://github.com/cloud-scouts/terraform-aws-github-runner/commit/ff39d4f30992f7e37db086ae01c49c9ce233334f))
...
* handle enable_on_demand_failover_for_errors default value ([ab8b15f](https://github.com/cloud-scouts/terraform-aws-github-runner/commit/ab8b15f9f2686a7a0cffe5b9de05432014a01cda))
* improve logging when there is an error retrieving ssm parameters ([#3962](https://github.com/cloud-scouts/terraform-aws-github-runner/issues/3962)) ([1498c8c](https://github.com/cloud-scouts/terraform-aws-github-runner/commit/1498c8c2bdc4e1df8fd3671f2cc2c59d86c3eb92))
* Incorrect syncer binary location in tf outputs ([#4274](https://github.com/cloud-scouts/terraform-aws-github-runner/issues/4274)) ([401a373](https://github.com/cloud-scouts/terraform-aws-github-runner/commit/401a373684a6b11acd705fe88afee19f3fa84b4c)), closes [#4137](https://github.com/cloud-scouts/terraform-aws-github-runner/issues/4137)
* job retry resource and queue naming ([#4099](https://github.com/cloud-scouts/terraform-aws-github-runner/issues/4099)) ([4344f18](https://github.com/cloud-scouts/terraform-aws-github-runner/commit/4344f18c4518ac0aa135bbdd8b4af13b34d36d63))
...
* **lambda:** bump @octokit/webhooks from 14.0.2 to 14.1.0 in /lambdas in the octokit group ([#4651](https://github.com/cloud-scouts/terraform-aws-github-runner/issues/4651)) ([754ffc8](https://github.com/cloud-scouts/terraform-aws-github-runner/commit/754ffc80fd7c70b3260be5d2c9ac88e350325cf9))
...
* **lambda:** bump the aws group across 1 directory with 2 updates ([#3955](https://github.com/cloud-scouts/terraform-aws-github-runner/issues/3955)) ([2e094cf](https://github.com/cloud-scouts/terraform-aws-github-runner/commit/2e094cf242fd910d2e2451ece3946f7232f048b7))
...
* mark github_app variable as sensitive ([#4013](https://github.com/cloud-scouts/terraform-aws-github-runner/issues/4013)) ([08be669](https://github.com/cloud-scouts/terraform-aws-github-runner/commit/08be669a9d04bb8c5930b69d17f12748720e6148))
* missing GHES URL for the retry lambda ([#4177](https://github.com/cloud-scouts/terraform-aws-github-runner/issues/4177)) ([3afbd5f](https://github.com/cloud-scouts/terraform-aws-github-runner/commit/3afbd5fb0952dbb37d7db216f325acf57cc3aa97))
* missing lambda s3 key and version for job retry ([#4074](https://github.com/cloud-scouts/terraform-aws-github-runner/issues/4074)) ([8540379](https://github.com/cloud-scouts/terraform-aws-github-runner/commit/8540379e36dd0e900e777684a55c51da80a5ef1b))
* only tag spot requests if no on-demand fallback ([2a28ef1](https://github.com/cloud-scouts/terraform-aws-github-runner/commit/2a28ef1bc5aeb0280b92c5f7b6aabf69c1a68b81))
* only tag spot rquests for spot ([a9ab69e](https://github.com/cloud-scouts/terraform-aws-github-runner/commit/a9ab69e90fe8e1f9df1c752757ef774eed42e278))
* only tag spot rquests for spot ([806bf58](https://github.com/cloud-scouts/terraform-aws-github-runner/commit/806bf580c177c5d2bbdad3b309c48e941b2c6eb4))
* pass lambda zip file to job retry feature ([#4080](https://github.com/cloud-scouts/terraform-aws-github-runner/issues/4080)) ([098c0ea](https://github.com/cloud-scouts/terraform-aws-github-runner/commit/098c0ea9ad96d31a2fa944d7eafe90861d8c6184)), closes [#4078](https://github.com/cloud-scouts/terraform-aws-github-runner/issues/4078)
* remove deprecated metric feature flag ([#4319](https://github.com/cloud-scouts/terraform-aws-github-runner/issues/4319)) ([70105b4](https://github.com/cloud-scouts/terraform-aws-github-runner/commit/70105b49d166088bd7f522005b95b40b7ab5b2e4))
* remove deprecated runners_scale_up_Lambda_memory_size as it breaks CDKTF ([#4276](https://github.com/cloud-scouts/terraform-aws-github-runner/issues/4276)) ([a2280f7](https://github.com/cloud-scouts/terraform-aws-github-runner/commit/a2280f74d45475804de730aeaf903670a3400bd1))
* remove deprecated variables ([#4073](https://github.com/cloud-scouts/terraform-aws-github-runner/issues/4073)) ([099c78d](https://github.com/cloud-scouts/terraform-aws-github-runner/commit/099c78dc5db0ccf71277b1d4941e05e72336cff8))
...
* remove job start hook with senstive information ([#3986](https://github.com/cloud-scouts/terraform-aws-github-runner/issues/3986)) ([bbcb470](https://github.com/cloud-scouts/terraform-aws-github-runner/commit/bbcb4707f698b29c470c0aadf81c9ac2c37781f8)), closes [#3980](https://github.com/cloud-scouts/terraform-aws-github-runner/issues/3980)
* remove unused example spot_instance_termination_watcher ([#4226](https://github.com/cloud-scouts/terraform-aws-github-runner/issues/4226)) ([ad865a7](https://github.com/cloud-scouts/terraform-aws-github-runner/commit/ad865a7df9393ede2958e53d9ecbb0a61e66053c))
...
* spot termination watcher output multi runner ([#4194](https://github.com/cloud-scouts/terraform-aws-github-runner/issues/4194)) ([367b1b3](https://github.com/cloud-scouts/terraform-aws-github-runner/commit/367b1b38285d63c0cc0fb8a991f69dcbac227222))
* support ephemeral runners for windows ([#4164](https://github.com/cloud-scouts/terraform-aws-github-runner/issues/4164)) ([44f5d6d](https://github.com/cloud-scouts/terraform-aws-github-runner/commit/44f5d6de244f5b23a1992aa36e49e41d605b659b))
* support Terraform AWS Provider v6 ([#4646](https://github.com/cloud-scouts/terraform-aws-github-runner/issues/4646)) ([aebef80](https://github.com/cloud-scouts/terraform-aws-github-runner/commit/aebef800ce165fd0df26d774f9c344c1cf02d245))
* Tag event rules, fix broken runner hook examples ([#4378](https://github.com/cloud-scouts/terraform-aws-github-runner/issues/4378)) ([6345ec2](https://github.com/cloud-scouts/terraform-aws-github-runner/commit/6345ec23580a02a3263c798dc2e0851aff89f328))
* trigger cold start dispatcher after update SSM parameters ([#4243](https://github.com/cloud-scouts/terraform-aws-github-runner/issues/4243)) ([580d24b](https://github.com/cloud-scouts/terraform-aws-github-runner/commit/580d24b6be14508d34c201fe764f35d34024ea57))
...
* use name instead of name prefix to avoid too long names ([#4079](https://github.com/cloud-scouts/terraform-aws-github-runner/issues/4079)) ([8bb6272](https://github.com/cloud-scouts/terraform-aws-github-runner/commit/8bb62724c41b6dbd3d3f484f32da9d46dc5ad853))
* **webhook:** add missing permission to workflow job queue (EventBridge) ([#4224](https://github.com/cloud-scouts/terraform-aws-github-runner/issues/4224)) ([d7e516c](https://github.com/cloud-scouts/terraform-aws-github-runner/commit/d7e516c4cc8b3c5091937730935efa716e6481bd))
* **webhook:** grant KMS permission to decrypt wehn using EventBridge ([#4220](https://github.com/cloud-scouts/terraform-aws-github-runner/issues/4220)) ([380bcaf](https://github.com/cloud-scouts/terraform-aws-github-runner/commit/380bcaf68447fb05be6c888392b46449cf5d409d))
